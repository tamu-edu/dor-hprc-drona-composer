...
def drona_add_additional_files(job_name, cores):
    drona_add_additional_file("testing_dynamic.txt", preview_order=2, preview_name="dynamic_file_order_2")
    if cores == "1":
        drona_add_additional_file("testing_dynamic2.txt", preview_name="dynamic_file_order_0")
